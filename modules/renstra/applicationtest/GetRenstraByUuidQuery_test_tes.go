...
func TestGetRenstraByUuid_Fail_NotFound(t *testing.T) {
	db, cleanup := setupRenstraMySQL(t)
	defer cleanup()
	...
	q := app.GetRenstraByUuidQuery{Uuid: notExistUuid}
...
func TestGetRenstraByUuid_Edge_InvalidUUID(t *testing.T) {
	db, cleanup := setupRenstraMySQL(t)
	defer cleanup()
	...
	q := app.GetRenstraByUuidQuery{Uuid: invalidUuid}
