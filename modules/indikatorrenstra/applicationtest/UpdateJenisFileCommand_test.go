...
import (
	...
	app "UnpakSiamida/modules/indikatorrenstra/application/UpdateIndikatorRenstra"
...
func TestUpdateIndikatorRenstraCommandValidation_Success(t *testing.T) {
	validCmd := app.UpdateIndikatorRenstraCommand{
	...
	err := app.UpdateIndikatorRenstraCommandValidation(validCmd)
	assert.NoError(t, err)
}

func TestUpdateIndikatorRenstraCommandValidation_Fail(t *testing.T) {
	invalidCmd := app.UpdateIndikatorRenstraCommand{
		Uuid:           "",
		StandarRenstra: "",
		Indikator:      "",
		Parent:         nil,
	...
	err := app.UpdateIndikatorRenstraCommandValidation(invalidCmd)
	assert.Error(t, err)
...
func TestUpdateIndikatorRenstraCommand_Success(t *testing.T) {
	db, terminate := setupIndikatorRenstraMySQL(t)
	defer terminate()

	handler := &app.UpdateIndikatorRenstraCommandHandler{
...
func TestUpdateIndikatorRenstraCommand_Fail(t *testing.T) {
	tests := []struct {
		name         string
		cmd          app.UpdateIndikatorRenstraCommand
		expectedCode string
