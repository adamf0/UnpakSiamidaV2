...
type ValidationBehaviorUser struct{}

func NewValidationBehaviorUser() *ValidationBehaviorUser {
	return &ValidationBehaviorUser{}
}

func (b *ValidationBehaviorUser) Handle(
	ctx context.Context,
	request interface{},
